(function () {
	...
	frappe.data_import.ImportPreview = class ImportPreview {
		...
		add_actions() {
			...
			var html = actions.filter(function (action) { return action.condition; }).map(function (action) {
		...
		show_column_mapper() {
			...
			var fields = this.preview_data.columns.map(function (col, i) {
				...
				if (!df) {
					...
					fieldname = df.parent === this$1.doctype
						? df.fieldname
