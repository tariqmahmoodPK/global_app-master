	...
	item_code: function (frm, cdt, cdn) {
		...
		frappe.call({
			...
			callback(r) {
				...
				var color_str = "";
				if (data.color_1) {
					color_str = data.color_1
				}
				if (data.color_2) {
					color_str += ", " + data.color_2
				}
				if (data.color_3) {
					color_str += ", " + data.color_3
				}
				if (data.color_4) {
					color_str += ", " + data.color_4
				}
				if (data.color_5) {
					color_str += ", " + data.color_5
				}
				if (data.color_6) {
					color_str += ", " + data.color_6
				}
				if (data.color_7) {
					color_str += ", " + data.color_7
				}
				if (data.color_8) {
					color_str += ", " + data.color_8
				}


				row.colors = color_str;
